...
<x-slot name="body_id">
  <body id="todays">
		...
		<div class="row">
		<div class="input-group">
			<h4 class="question">建物外は何回移動するしましたか？</h4><input class="form-control" id="move_out_number" max="4" min="0" name="move_out_number" min="0" pattern="\d*" type="number"><label class="input-group-text" for="light_led_soho">回</label>
		</div></div>
		<div class="input-group">
