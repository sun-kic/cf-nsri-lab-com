...
<x-slot name="body_id">
  <body id="todays">
    ...
    <section class="work-data">
		...
		<div class="row">
			<div class="input-group col">
				<h4 class="question">建物内は何回移動しましたか？</h4><input type="number" pattern="\d*" min="0" class="form-control" name="move_floor_number" id="move_floor_number"><label class="input-group-text" for="move_floor_number">回</label>
			</div>
			<div class="switch-button col">
		...
		<div class="row">
		<div class="input-group">
			<h4 class="question">建物外は何回移動しましたか？</h4>
