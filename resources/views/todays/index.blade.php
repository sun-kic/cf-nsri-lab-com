...
<x-slot name="body_id">
  <body id="todays">
          ...
          @csrf
            ...
            <div class="scroll">
                ...
                <dd><div class="time-line"><span></span><span></span><span></span></div></dd>
                    ...
                    @php
                        $work_office_hours = $today && $today->work_office ? array_map('intval', explode(",", $today->work_office)) : [];
                        $work_soho_hours = $today && $today->work_soho ? array_map('intval', explode(",", $today->work_soho)) : [];
                        $work_3pl_hours = $today && $today->work_3pl ? array_map('intval', explode(",", $today->work_3pl)) : [];
                        $life_hours = $today && $today->life ? array_map('intval', explode(",", $today->life)) : [];
                        $move_hours = $today && $today->move ? array_map('intval', explode(",", $today->move)) : [];
                        $office_area = $today ? $today->office_area : '';
                    @endphp
                    
                    @for ($i = 0; $i <= 23; $i++)
                        @if (in_array($i, $work_office_hours))          
                ...
                <dt>働く･在宅勤務</dt>
                <dd class="time-schedule">
                <div class="btn-group home-work" role="group">
                  @for ($i=0;$i<=23;$i++)
                  @if (in_array($i,$work_soho_hours))          
        ...
        <div class="input-group">
            ...
            <input type="number" pattern="\d*" min="0" class="form-control" name="office_area" value="{{ $office_area }}">
            <span class="input-group-text">m&sup2;</span>
        </div>
            <div class="input-group">
                <span class="input-group-text question">在室人数</span>
                <input class="form-control" min="0" name="office_person" pattern="\d*" type="number">
			...
			<div class="radio-inline-group">
				<div class="three-parts">
                    <input type="radio" name="three_pl_type" id="three_pl_type0" value="サードプレイスに行っていません">
                    <label for="three_pl_type0">サードプレイスに行っていません</label>
                </div>
                <div class="three-parts">
                  <input type="radio" name="three_pl_type" id="three_pl_type1" value="自宅以外の住宅">
                  <label for="three_pl_type1">自宅以外の住宅</label>
                </div>
                <div class="three-parts">
                  <input type="radio" name="three_pl_type" id="three_pl_type2" value="喫茶店やシェアオフィス">
    ...
    <section class="work-data">
		<h3>働くスタイルについて</h3>
            ...
            <div class="row">
		<div class="input-group col">
                <label for="light_time_office" class="input-group-text">オフィス</label><input type="number" min="0" max="24" pattern="\d*" class="form-control" name="light_time_office" id="light_time_office">
            ...
            <div class="row">
			<div class="input-group col">
            <label class="input-group-text" for="light_time_soho">在宅勤務</label>
                  <input type="number" min="0" max="24" pattern="\d*" class="form-control" name="light_time_soho" id="light_time_soho"><span class="input-group-text">時間</span>
                </div>
				<div class="switch-button col">
            ...
            <div class="row">
			<div class="input-group col">
                <label class="input-group-text" for="light_time_3pl">サードプレイス（その他の場所）</label>
                  <input type="number" min="0" max="24" pattern="\d*" class="form-control" name="light_time_3pl" id="light_time_3pl"> <span class="input-group-text">時間</span>
            </div>
				<div class="switch-button col">
            ...
            <div class="row">
			<div class="input-group">
                <label for="ac_time_office" class="input-group-text">オフィス</label><input type="number" min="0" max="24" pattern="\d*" class="form-control" name="ac_time_office" id="ac_time_office">
                <span class="input-group-text">時間</span>
            </div>
            </div>
            <div class="row">
			<div class="input-group">
                ...
                <input type="number" min="0" max="24" pattern="\d*" class="form-control" name="ac_time_soho" id="ac_time_soho">
                <label for="ac_time_soho" class="input-group-text">時間</label>
			</div>
        </div>
            <div class="row">
			<div class="input-group">
				<label class="input-group-text" for="ac_time_3pl">サードプレイス</label><input type="number" min="0" max="24" pattern="\d*" class="form-control" name="ac_time_3pl" id="ac_time_3pl"> <label class="input-group-text" for="ac_time_3pl">時間</label>
            </div>
            </div>
			<div class="input-group">
				<h4 class="question">何枚、プリントアウトやコピーを取りましたか？</h4><input type="number" pattern="\d*" class="form-control" name="printed_paper" id="printed_paper"><label class="input-group-text" for="printed_paper">枚</label>
            </div>
			<div class="input-group">
				<h4 class="question">パソコン作業しましたか？</h4><input  type="number" pattern="\d*" class="form-control" name="pc_time" id="pc_time"><label class="input-group-text" for="pc_time">時間</label>
            </div>
			<div class="input-group">
		...
		<div class="row">
			<div class="input-group col">
				<h4 class="question">建物内は何回移動するしましたか？</h4><input type="number" pattern="\d*" min="0" class="form-control" name="move_floor_number" id="move_floor_number"><label class="input-group-text" for="move_floor_number">回</label>
			</div>
			<div class="switch-button col">
				<label class="input-group-text" for="move_walk">階段を利用しましたか？</label>
				<div class="button">
		...
		<div class="row">
		<div class="input-group">
			<h4 class="question">建物外は何回移動するしましたか？</h4>
            <input type="number" min="0" max="4"pattern="\d*" class="form-control" name="move_out_number" id="move_out_number"><label class="input-group-text" for="light_led_soho">回</label>
            </div></div>
            <div class="input-group">
			<div class="transportation-col">
                <label for="move_out_departure1" class="input-group-text">出発地</label>
                  <input type="text" class="form-control" name="move_out_departure1" id="move_out_departure1">                
			</div>
			<div class="transportation-col">
                <label for="move_out_arrival1" class="input-group-text">到着地</label>
                  <input type="text" class="form-control" name="move_out_arrival1" id="move_out_arrival1">
            </div>
            <div class="transportation-col">
		...
		<div class="input-group border-top_sp">
			<div class="transportation-col">
                <label for="move_out_departure2" class="input-group-text">出発地</label>
                  <input type="text" class="form-control" name="move_out_departure2" id="move_out_departure2">
			</div>
			<div class="transportation-col">
                <label for="move_out_arrival2" class="input-group-text">到着地</label>
                  <input type="text" class="form-control" name="move_out_arrival2" id="move_out_arrival2">
			</div>
            <div class="transportation-col">
		...
		<div class="input-group border-top_sp">
			<div class="transportation-col">
                <label for="move_out_departure3" class="input-group-text">出発地</label>
                  <input type="text" class="form-control" name="move_out_departure3" id="move_out_departure3">
			</div>
			<div class="transportation-col">
                <label for="move_out_arrival3" class="input-group-text">到着地</label>
                  <input type="text" class="form-control" name="move_out_arrival3" id="move_out_arrival3">
			</div>
            <div class="transportation-col">
		...
		<div class="input-group border-top_sp">
			<div class="transportation-col">
                <label for="move_out_departure4" class="input-group-text">出発地</label>
                  <input type="text" class="form-control" name="move_out_departure4" id="move_out_departure4">
			</div>
			<div class="transportation-col">
                <label for="move_out_arrival4" class="input-group-text">到着地</label>
                  <input type="text" class="form-control" name="move_out_arrival4" id="move_out_arrival4">
			</div>
            <div class="transportation-col">
